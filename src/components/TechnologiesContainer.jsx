...
const technologies = [
  ...
  { id: "zod", name: "Zod", icon: <SiZod />, level: "Intermediário" },
  { id: "fast", name: "Fastify", icon: <SiFastify />, level: "Intermediário" },
  { id: "es", name: "Eslint", icon: <SiEslint />, level: "Intermediário" },
  { id: "sql", name: "Sqlite", icon: <SiSqlite />, level: "Intermediário" },
